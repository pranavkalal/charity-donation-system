...
import { getCampaignBySlug } from "../api/campaignAPI"; // Adjust this to match your API method
...
const CampaignDesc = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-gray-50 pb-12">
      {/* Top Bar */}
      <div className="w-full bg-white shadow-sm p-4 flex justify-center border-b">
        <h1 className="text-xl font-semibold text-gray-800">Campaigns</h1>
      </div>
